    ...
    return (
        ...
        <div className="border-4 border-gray-200 rounded-md p-4">
            ...
            <form onSubmit={handleSubmit} className="label *:block [&_input]:w-full [&_input]:mb-2">
                ...
                <input name="preco" id="preco" value={preco} onChange={(e) => {setPreco(e.target.value)}} type="number" placeholder="Ex: R$ 2.500" className="border-2 rounded-sm border-gray-300"></input>
